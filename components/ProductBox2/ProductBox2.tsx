...
import { ProductBox2Props } from 'types';

const ProductBox21: any = styled('div')({
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
  flexDirection: `row`,
...
function ProductBox2(props: ProductBox2Props): JSX.Element {
  return (
    <ProductBox21 className={props.className}>
      <Bg></Bg>
      <ProductImage
        src={`assets/images/ProductBox2_Product_Image.png`}
        loading="lazy"
        alt={'Product Image'}
      />
