...
import { HubEssentialsProps } from 'types';
import useHubEssentials from 'components/HubEssentials/useHubEssentials';
...
const HubEssentials1Span1: any = styled('span', {
  shouldForwardProp: (prop: any) => !['data'].includes(prop.toString()),
})(({ theme, data }: any) => ({
  whiteSpace: `pre-wrap`,
  color: `rgba(0, 0, 0, 1)`,
...
const HubEssentials1Span2: any = styled('span', {
  shouldForwardProp: (prop: any) => !['data'].includes(prop.toString()),
})(({ theme, data }: any) => ({
  whiteSpace: `pre-wrap`,
...
const HubEssentials1: any = styled('div', {
  shouldForwardProp: (prop: any) => !['data'].includes(prop.toString()),
})(({ theme, data }: any) => ({
  textAlign: `center`,
  whiteSpace: `pre-wrap`,
...
const AmplifyingYourSurfac: any = styled('div')(({ theme }: any) => ({
  textAlign: `center`,
  whiteSpace: `pre-wrap`,
  fontSynthesis: `none`,
...
function HubEssentials(props: HubEssentialsProps): JSX.Element {
  const { data } = useHubEssentials();

  return (
    <ScreenDesktop className={props.className} data={data}>
      <Rows>
        <Intro>
          <HubEssentials1 data={data}>
            <HubEssentials1Span1 data={data}>{`Hub `}</HubEssentials1Span1>
            <HubEssentials1Span2
              data={data}
            >{`Essentials`}</HubEssentials1Span2>
          </HubEssentials1>
          <AmplifyingYourSurfac>
            {`Amplifying Your Surface Hub Experience`}
          </AmplifyingYourSurfac>
        </Intro>
        <Box1>
          <ProductCarousel1 />
