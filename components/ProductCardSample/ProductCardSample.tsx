...
import ContentcontainerSamp from 'components/ContentcontainerSamp/ContentcontainerSamp';
import { ProductCardSampleProps } from 'types';
import useProductCardSample from 'components/ProductCardSample/useProductCardSample';
...
const ContentcontainerSamp1: any = styled(ContentcontainerSamp)(
  ({ theme }: any) => ({
    width: `1080px`,
    margin: `0px`,
  })
...
function ProductCardSample(props: ProductCardSampleProps): JSX.Element {
  const { data, fns } = useProductCardSample();
    ...
    <StateDefault className={props.className}>
      <Productcardcontainer>
        <ProductCardNew>
          <Imagecontainer>
            <ProductImage
              src={`assets/images/ProductCardSample_Product_Image.png`}
              loading="lazy"
              alt={'Product Image'}
            />
          </Imagecontainer>
