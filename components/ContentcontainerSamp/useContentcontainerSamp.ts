...
import useContentcontainerSampResponsiveSize from './useContentcontainerSampResponsiveSize';
...
const useContentcontainerSamp = (props: ContentcontainerSampProps) => {
  const [currentVariant, setCurrentVariant] = React.useState<string>(
    variantOptions['ScreenDesktop']
  );

  const breakpointsVariant = useContentcontainerSampResponsiveSize();
...
export default useContentcontainerSamp;
