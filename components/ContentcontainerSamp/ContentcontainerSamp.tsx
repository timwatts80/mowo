...
import { ContentcontainerSampProps } from 'types';
import useContentcontainerSamp from 'components/ContentcontainerSamp/useContentcontainerSamp';
...
function ContentcontainerSamp(props: ContentcontainerSampProps): JSX.Element {
  const { data } = useContentcontainerSamp(props);
          ...
          <Details data={data}>
            ...
            <Frame186 data={data}>
              <Colors data={data}>
                ...
                <Colorswatches>
                  <Color1
                    src={`assets/images/ContentcontainerSamp_color1.png`}
                    loading="lazy"
                    alt={'color1'}
                  />
                  <Color2
                    src={`assets/images/ContentcontainerSamp_color2.png`}
                    loading="lazy"
                    alt={'color2'}
                  />
                  <Color3
                    src={`assets/images/ContentcontainerSamp_color3.png`}
                    loading="lazy"
                    alt={'color3'}
                  />
                </Colorswatches>
              ...
              <Frame156 data={data}>
                <ButtonContained onClick={props.onClose}>
                  <Base>
                    <MaskedIcon>
                      <IconLeft>
                        <Vector
                          src={`assets/images/ContentcontainerSamp_Vector.png`}
                          loading="lazy"
                          alt={'Vector'}
                        />
                      </IconLeft>
...
export default ContentcontainerSamp;
