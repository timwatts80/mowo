...
import { ProductDialog1Props } from 'types';

const ProductDialog: any = styled('div')(({ theme }: any) => ({
...
function ProductDialog1(props: ProductDialog1Props): JSX.Element {
  return (
    props.open && (
      <ProductDialog className={props.className}>
        <Pagecontainer>
          <Close>
