...
import { ProductCardRefProps } from 'types';
import useProductCardRef from 'components/ProductCardRef/useProductCardRef';

const ProductCard: any = styled('div')({
  borderRadius: `0px`,
  display: `flex`,
  position: `relative`,
  isolation: `isolate`,
...
function ProductCardRef(props: ProductCardRefProps): JSX.Element {
  const { data, fns } = useProductCardRef();
