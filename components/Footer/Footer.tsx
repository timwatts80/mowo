          ...
          <BottomRows>
            ...
            <BottomRow1>
              <QuestContainer2>
                <QuestLogoTraced2>
                  <Layer12
                    src={`assets/images/Footer_Layer_1_2.png`}
                    loading="lazy"
                    alt={'Layer 1'}
                  />
                  <Layer22
                    src={`assets/images/Footer_Layer_2_2.png`}
                    loading="lazy"
                    alt={'Layer 2'}
                  />
                  <Layer32
                    src={`assets/images/Footer_Layer_3_2.png`}
                    loading="lazy"
                    alt={'Layer 3'}
                  />
                  <Layer42
                    src={`assets/images/Footer_Layer_4_2.png`}
                    loading="lazy"
                    alt={'Layer 4'}
                  />
                  <Layer52
                    src={`assets/images/Footer_Layer_5_2.png`}
                    loading="lazy"
                    alt={'Layer 5'}
                  />
                  <Layer62
                    src={`assets/images/Footer_Layer_6_2.png`}
                    loading="lazy"
                    alt={'Layer 6'}
                  />
                  <Layer72
                    src={`assets/images/Footer_Layer_7_2.png`}
                    loading="lazy"
                    alt={'Layer 7'}
                  />
                  <Layer82
