...
import { ProductCardAnimProps } from 'types';
import { animated, useSpring, easings } from 'react-spring';
import useProductCardAnim from 'components/ProductCardAnim/useProductCardAnim';
...
function ProductCardAnim(props: ProductCardAnimProps): JSX.Element {
  const { data, fns } = useProductCardAnim();
  ...
  const ProductImageStateDefault = { zIndex: `0`, top: `-84px` };
  const ProductImageStateHover = { zIndex: `0`, top: `24px` };
  ...
  const ProductcardbackgrounStateDefault = { zIndex: `1` };
  const ProductcardbackgrounStateHover = { zIndex: `0` };
...
export default ProductCardAnim;
